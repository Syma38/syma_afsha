                ...
                <div className="content-container">
                    ...
                    <div className={`content ${getActiveClass(2, "active-content")}`}>
                        ...
                        <li> Robotics </li>
                            ...
                            <li>Mobile Cellular Technology</li>
                        </ul>
                    </div>
                    <div className={`content ${getActiveClass(3, "active-content")}`}>
                        ...
                        <p>
                            ...
                            TensorFlow, Scikit-Learn</p>
                        <p>
                            <h style={{ color: "#bcc4b7" }}>App Development</h> :
                            Flutter, Android Studio</p>
                        <p>
                            <h style={{ color: "#bcc4b7" }}>Visualisation</h>:
                            Matplotlib, Seaborn</p> <p>
                            <h style={{ color: "#bcc4b7" }}>Software and Tools</h>: CodeBlocks, Emu8086, Cisco Packet Tracer, Visual Studio, Proteus Design Suite, LTSpice, AutoCAD, Adobe
                            Illustrator, Simulink, Microwind, DSCH, QUARTUS’Ⅱ</p> <p>
                            <h style={{ color: "#bcc4b7" }}>Hardware</h> : Arduino</p> <p>
                            <h style={{ color: "#bcc4b7" }}>Version Control</h>  : Git</p>
                        <p>
                            <h style={{ color: "#bcc4b7" }}>Image
                                Processing</h> : MATLAB, OpenCV</p>



                        <h style={{ color: "teal" }}> <u><b>Selected Certifications</b></u></h>
                        <ul>
                            <li>
...
<h> ✓ Learned the necessary skills and technical information of the power field by exploring different factories.</h>
                    ...
                    <div className={`content ${getActiveClass(5, "active-content")}`}>
                        <ul style={{ listStyleType: "circle" }}>
                            ...
                            <li>Working on Sign Language Translation Module, Violence Detection Module and Film Censorship and Rating
                                Module. <i style={{ color: 'yellow' }}>2021-Present</i></li>
