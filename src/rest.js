...
export default function Rest(){
    return(
        <div className="rest">
                      ...
                      <p style={{color: "white", fontFamily: "serif", fontSize:20}}>To follow my work at <a  style={{ color: "#cf2e2e"}} href="https://www.researchgate.net/profile/Syma-Afsha" target="_blank">ResearchGate</a>.</p>
                  <Row>
                  <Col xs={4} sm={4} lg={3} >
